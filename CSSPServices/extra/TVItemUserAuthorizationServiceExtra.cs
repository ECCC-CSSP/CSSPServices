...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated TVItemUserAuthorizationFillReport
        private IQueryable<TVItemUserAuthorizationReport> FillTVItemUserAuthorizationReport()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> TVAuthEnumList = enums.GetEnumTextOrderedList(typeof(TVAuthEnum));

             IQueryable<TVItemUserAuthorizationReport>  TVItemUserAuthorizationReportQuery = (from c in db.TVItemUserAuthorizations
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new TVItemUserAuthorizationReport
                    {
                        TVItemUserAuthorizationReportTest = "Testing Report",
        ...
        #endregion Functions private Generated TVItemUserAuthorizationFillReport
