...
namespace CSSPServices
{
    ...
    public partial class TideDataValueService : BaseService
    {
        ...
        /// <summary>
        /// Gets the TideDataValueExtraA model with the TideDataValueID identifier
        /// </summary>
        /// <param name="TideDataValueID">Is the identifier of [TideDataValues](CSSPModels.TideDataValue.html) table of CSSPDB</param>
        /// <returns>[TideDataValueExtraA](CSSPModels.TideDataValueExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TideDataValueExtraA](CSSPModels.TideDataValueExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TideDataValueExtraA](CSSPModels.TideDataValueExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the TideDataValueExtraB model with the TideDataValueID identifier
        /// </summary>
        /// <param name="TideDataValueID">Is the identifier of [TideDataValues](CSSPModels.TideDataValue.html) table of CSSPDB</param>
        /// <returns>[TideDataValueExtraB](CSSPModels.TideDataValueExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TideDataValueExtraB](CSSPModels.TideDataValueExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TideDataValueExtraB](CSSPModels.TideDataValueExtraB.html)</returns>
