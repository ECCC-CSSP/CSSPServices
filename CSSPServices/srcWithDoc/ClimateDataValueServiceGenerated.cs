...
namespace CSSPServices
{
    ...
    public partial class ClimateDataValueService : BaseService
    {
        ...
        /// <summary>
        /// Gets the ClimateDataValueExtraA model with the ClimateDataValueID identifier
        /// </summary>
        /// <param name="ClimateDataValueID">Is the identifier of [ClimateDataValues](CSSPModels.ClimateDataValue.html) table of CSSPDB</param>
        /// <returns>[ClimateDataValueExtraA](CSSPModels.ClimateDataValueExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [ClimateDataValueExtraA](CSSPModels.ClimateDataValueExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [ClimateDataValueExtraA](CSSPModels.ClimateDataValueExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the ClimateDataValueExtraB model with the ClimateDataValueID identifier
        /// </summary>
        /// <param name="ClimateDataValueID">Is the identifier of [ClimateDataValues](CSSPModels.ClimateDataValue.html) table of CSSPDB</param>
        /// <returns>[ClimateDataValueExtraB](CSSPModels.ClimateDataValueExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [ClimateDataValueExtraB](CSSPModels.ClimateDataValueExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [ClimateDataValueExtraB](CSSPModels.ClimateDataValueExtraB.html)</returns>
