...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated ClimateDataValueFillReport
        private IQueryable<ClimateDataValueReport> FillClimateDataValueReport()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> StorageDataTypeEnumList = enums.GetEnumTextOrderedList(typeof(StorageDataTypeEnum));

             IQueryable<ClimateDataValueReport>  ClimateDataValueReportQuery = (from c in db.ClimateDataValues
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new ClimateDataValueReport
                    {
                        ClimateDataValueReportTest = "Testing Report",
        ...
        #endregion Functions private Generated ClimateDataValueFillReport
