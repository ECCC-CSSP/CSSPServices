...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMWQMRunExtraA
        private IQueryable<MWQMRunExtraA> FillMWQMRunExtraA()
        {
            ...
            List<EnumIDAndText> TideTextEnumList = enums.GetEnumTextOrderedList(typeof(TideTextEnum));
             ...
             IQueryable<MWQMRunExtraA> MWQMRunExtraAQuery = (from c in db.MWQMRuns
        ...
        #endregion Functions private Generated FillMWQMRunExtraA
