...
namespace CSSPServices.Tests
{
    ...
    public partial class BoxModelResultTest : TestHelper
    {
        ...
        private BoxModelResult GetFilledRandomBoxModelResult(string OmitPropName)
        {
            ...
            if (OmitPropName != "Volume_m3") boxModelResult.Volume_m3 = GetRandomFloat(0, 900000);
            if (OmitPropName != "Surface_m2") boxModelResult.Surface_m2 = GetRandomFloat(0, 900000);
            if (OmitPropName != "Radius_m") boxModelResult.Radius_m = GetRandomFloat(0, 100000);
            if (OmitPropName != "LeftSideDiameterLineAngle_deg") boxModelResult.LeftSideDiameterLineAngle_deg = GetRandomFloat(0, 360);
            if (OmitPropName != "CircleCenterLatitude") boxModelResult.CircleCenterLatitude = GetRandomFloat(-90, 90);
            if (OmitPropName != "CircleCenterLongitude") boxModelResult.CircleCenterLongitude = GetRandomFloat(-180, 180);
            if (OmitPropName != "FixLength") boxModelResult.FixLength = true;
            if (OmitPropName != "FixWidth") boxModelResult.FixWidth = true;
            if (OmitPropName != "RectLength_m") boxModelResult.RectLength_m = GetRandomFloat(0, 100000);
            if (OmitPropName != "RectWidth_m") boxModelResult.RectWidth_m = GetRandomFloat(0, 100000);
            if (OmitPropName != "LeftSideLineAngle_deg") boxModelResult.LeftSideLineAngle_deg = GetRandomFloat(0, 360);
            if (OmitPropName != "LeftSideLineStartLatitude") boxModelResult.LeftSideLineStartLatitude = GetRandomFloat(-90, 90);
            if (OmitPropName != "LeftSideLineStartLongitude") boxModelResult.LeftSideLineStartLongitude = GetRandomFloat(-180, 180);
        ...
        public void BoxModelResult_Testing()
        {
            ...
            boxModelResult = null;
            boxModelResult = GetFilledRandomBoxModelResult("BoxModelResultType");
            Assert.AreEqual(false, boxModelResultService.Add(boxModelResult));
            Assert.AreEqual(1, boxModelResult.ValidationResults.Count());
            Assert.IsTrue(boxModelResult.ValidationResults.Where(c => c.ErrorMessage == string.Format(ServicesRes._IsRequired, ModelsRes.BoxModelResultBoxModelResultType)).Any());
            Assert.AreEqual(BoxModelResultTypeEnum.Error, boxModelResult.BoxModelResultType);
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());

            // Volume_m3 will automatically be initialized at 0.0f --> not null

            // Surface_m2 will automatically be initialized at 0.0f --> not null

            // Radius_m will automatically be initialized at 0.0f --> not null

            // LeftSideDiameterLineAngle_deg will automatically be initialized at 0.0f --> not null

            // CircleCenterLatitude will automatically be initialized at 0.0f --> not null

            // CircleCenterLongitude will automatically be initialized at 0.0f --> not null

            // FixLength will automatically be initialized at false --> not null

            // FixWidth will automatically be initialized at false --> not null

            // RectLength_m will automatically be initialized at 0.0f --> not null

            // RectWidth_m will automatically be initialized at 0.0f --> not null

            // LeftSideLineAngle_deg will automatically be initialized at 0.0f --> not null

            // LeftSideLineStartLatitude will automatically be initialized at 0.0f --> not null

            // LeftSideLineStartLongitude will automatically be initialized at 0.0f --> not null
            ...
            //-----------------------------------
            // doing property [BoxModelResultID] of type [int]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [Volume_m3] of type [float]
            //-----------------------------------

            boxModelResult = null;
            boxModelResult = GetFilledRandomBoxModelResult("");
            // Volume_m3 has Min [0] and Max [900000]. At Min should return true and no errors
            ...
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Volume_m3 has Min [0] and Max [900000]. At Min + 1 should return true and no errors
            ...
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Volume_m3 has Min [0] and Max [900000]. At Min - 1 should return false with one error
            boxModelResult.Volume_m3 = -1.0f;
            Assert.AreEqual(false, boxModelResultService.Add(boxModelResult));
            Assert.IsTrue(boxModelResult.ValidationResults.Where(c => c.ErrorMessage == string.Format(ServicesRes._ValueShouldBeBetween_And_, ModelsRes.BoxModelResultVolume_m3, "0", "900000")).Any());
            Assert.AreEqual(-1.0f, boxModelResult.Volume_m3);
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Volume_m3 has Min [0] and Max [900000]. At Max should return true and no errors
            boxModelResult.Volume_m3 = 900000.0f;
            Assert.AreEqual(true, boxModelResultService.Add(boxModelResult));
            Assert.AreEqual(0, boxModelResult.ValidationResults.Count());
            Assert.AreEqual(900000.0f, boxModelResult.Volume_m3);
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Volume_m3 has Min [0] and Max [900000]. At Max - 1 should return true and no errors
            boxModelResult.Volume_m3 = 899999.0f;
            Assert.AreEqual(true, boxModelResultService.Add(boxModelResult));
            Assert.AreEqual(0, boxModelResult.ValidationResults.Count());
            Assert.AreEqual(899999.0f, boxModelResult.Volume_m3);
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Volume_m3 has Min [0] and Max [900000]. At Max + 1 should return false with one error
            boxModelResult.Volume_m3 = 900001.0f;
            Assert.AreEqual(false, boxModelResultService.Add(boxModelResult));
            Assert.IsTrue(boxModelResult.ValidationResults.Where(c => c.ErrorMessage == string.Format(ServicesRes._ValueShouldBeBetween_And_, ModelsRes.BoxModelResultVolume_m3, "0", "900000")).Any());
            Assert.AreEqual(900001.0f, boxModelResult.Volume_m3);
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());

            //-----------------------------------
            // doing property [Surface_m2] of type [float]
            //-----------------------------------

            boxModelResult = null;
            boxModelResult = GetFilledRandomBoxModelResult("");
            // Surface_m2 has Min [0] and Max [900000]. At Min should return true and no errors
            ...
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Surface_m2 has Min [0] and Max [900000]. At Min + 1 should return true and no errors
            ...
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Surface_m2 has Min [0] and Max [900000]. At Min - 1 should return false with one error
            boxModelResult.Surface_m2 = -1.0f;
            Assert.AreEqual(false, boxModelResultService.Add(boxModelResult));
            Assert.IsTrue(boxModelResult.ValidationResults.Where(c => c.ErrorMessage == string.Format(ServicesRes._ValueShouldBeBetween_And_, ModelsRes.BoxModelResultSurface_m2, "0", "900000")).Any());
            Assert.AreEqual(-1.0f, boxModelResult.Surface_m2);
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Surface_m2 has Min [0] and Max [900000]. At Max should return true and no errors
            boxModelResult.Surface_m2 = 900000.0f;
            Assert.AreEqual(true, boxModelResultService.Add(boxModelResult));
            Assert.AreEqual(0, boxModelResult.ValidationResults.Count());
            Assert.AreEqual(900000.0f, boxModelResult.Surface_m2);
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Surface_m2 has Min [0] and Max [900000]. At Max - 1 should return true and no errors
            boxModelResult.Surface_m2 = 899999.0f;
            Assert.AreEqual(true, boxModelResultService.Add(boxModelResult));
            Assert.AreEqual(0, boxModelResult.ValidationResults.Count());
            Assert.AreEqual(899999.0f, boxModelResult.Surface_m2);
            Assert.AreEqual(true, boxModelResultService.Delete(boxModelResult));
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());
            // Surface_m2 has Min [0] and Max [900000]. At Max + 1 should return false with one error
            boxModelResult.Surface_m2 = 900001.0f;
            Assert.AreEqual(false, boxModelResultService.Add(boxModelResult));
            Assert.IsTrue(boxModelResult.ValidationResults.Where(c => c.ErrorMessage == string.Format(ServicesRes._ValueShouldBeBetween_And_, ModelsRes.BoxModelResultSurface_m2, "0", "900000")).Any());
            Assert.AreEqual(900001.0f, boxModelResult.Surface_m2);
            Assert.AreEqual(0, boxModelResultService.GetRead().Count());

            //-----------------------------------
            // doing property [Radius_m] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [LeftSideDiameterLineAngle_deg] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [CircleCenterLatitude] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [CircleCenterLongitude] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [FixLength] of type [bool]
            //-----------------------------------

            //-----------------------------------
            // doing property [FixWidth] of type [bool]
            //-----------------------------------

            //-----------------------------------
            // doing property [RectLength_m] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [RectWidth_m] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [LeftSideLineAngle_deg] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [LeftSideLineStartLatitude] of type [float]
            //-----------------------------------
            ...
            //-----------------------------------
            // doing property [LeftSideLineStartLongitude] of type [float]
            //-----------------------------------
