...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated TVFileFillReport
        private IQueryable<TVFileReport> FillTVFileReport()
        {
            ...
            List<EnumIDAndText> FileTypeEnumList = enums.GetEnumTextOrderedList(typeof(FileTypeEnum));
             ...
             IQueryable<TVFileReport>  TVFileReportQuery = (from c in db.TVFiles
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new TVFileReport
                    {
                        TVFileReportTest = "Testing Report",
        ...
        #endregion Functions private Generated TVFileFillReport
