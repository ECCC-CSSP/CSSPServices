...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillTVItem_B
        private IQueryable<TVItem_B> FillTVItem_B()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> TVTypeEnumList = enums.GetEnumTextOrderedList(typeof(TVTypeEnum));

             IQueryable<TVItem_B> TVItem_BQuery = (from c in db.TVItems
        ...
        #endregion Functions private Generated FillTVItem_B
