...
namespace CSSPServices.Tests
{
    ...
    public partial class ReportSectionLanguageServiceTest : TestHelper
    {
        ...
        public void GetReportSectionLanguageWithReportSectionLanguageID__reportSectionLanguage_ReportSectionLanguageID__Test()
        {
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    ...
                    {
                        reportSectionLanguageService.Query.Extra = extra;
        ...
        {
            Assert.IsFalse(string.IsNullOrWhiteSpace(reportSectionLanguageExtraAList[0].LastUpdateContactText));
        ...
        private void CheckReportSectionLanguageExtraBFields(List<ReportSectionLanguageExtraB> reportSectionLanguageExtraBList)
        {
            ...
            Assert.IsFalse(string.IsNullOrWhiteSpace(reportSectionLanguageExtraBList[0].LastUpdateContactText));
