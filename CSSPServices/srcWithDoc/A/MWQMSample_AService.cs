...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMWQMSample_A
        private IQueryable<MWQMSample_A> FillMWQMSample_A()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> SampleTypeEnumList = enums.GetEnumTextOrderedList(typeof(SampleTypeEnum));

             IQueryable<MWQMSample_A> MWQMSample_AQuery = (from c in db.MWQMSamples
        ...
        #endregion Functions private Generated FillMWQMSample_A
