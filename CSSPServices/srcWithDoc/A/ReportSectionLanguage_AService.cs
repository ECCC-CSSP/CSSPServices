...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillReportSectionLanguage_A
        private IQueryable<ReportSectionLanguage_A> FillReportSectionLanguage_A()
        {
            ...
            List<EnumIDAndText> TranslationStatusEnumList = enums.GetEnumTextOrderedList(typeof(TranslationStatusEnum));
             ...
             IQueryable<ReportSectionLanguage_A> ReportSectionLanguage_AQuery = (from c in db.ReportSectionLanguages
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new ReportSectionLanguage_A
                    {
        ...
        #endregion Functions private Generated FillReportSectionLanguage_A
