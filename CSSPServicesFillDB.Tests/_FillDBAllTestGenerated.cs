...
namespace CSSPServicesFillDB.Tests
{
    ...
    public partial class FillDBTest : TestHelper
    {
        ...
        public FillDBTest() : base()
        {
            ...
            addressService = new AddressService(LanguageRequest, db, ContactID);
            appErrLogService = new AppErrLogService(LanguageRequest, db, ContactID);
            appTaskService = new AppTaskService(LanguageRequest, db, ContactID);
            emailDistributionListContactService = new EmailDistributionListContactService(LanguageRequest, db, ContactID);
            emailDistributionListService = new EmailDistributionListService(LanguageRequest, db, ContactID);
            mwqmSampleDuplicateItemService = new MWQMSampleDuplicateItemService(LanguageRequest, db, ContactID);
            mwqmSiteSampleFCService = new MWQMSiteSampleFCService(LanguageRequest, db, ContactID);
            newContactService = new NewContactService(LanguageRequest, db, ContactID);
            uRLNumberOfSamplesService = new URLNumberOfSamplesService(LanguageRequest, db, ContactID);
            vpScenarioIDAndRawResultsService = new VPScenarioIDAndRawResultsService(LanguageRequest, db, ContactID);
            vpResValuesService = new VPResValuesService(LanguageRequest, db, ContactID);
            vpFullService = new VPFullService(LanguageRequest, db, ContactID);
            vectorService = new VectorService(LanguageRequest, db, ContactID);
            tvTypeNamesAndPathService = new TVTypeNamesAndPathService(LanguageRequest, db, ContactID);
            tvTextLanguageService = new TVTextLanguageService(LanguageRequest, db, ContactID);
            tvLocationService = new TVLocationService(LanguageRequest, db, ContactID);
            tvItemTVAuthService = new TVItemTVAuthService(LanguageRequest, db, ContactID);
            tvItemInfrastructureTypeTVItemLinkService = new TVItemInfrastructureTypeTVItemLinkService(LanguageRequest, db, ContactID);
            tvItemSubsectorAndMWQMSiteService = new TVItemSubsectorAndMWQMSiteService(LanguageRequest, db, ContactID);
            tvFullTextService = new TVFullTextService(LanguageRequest, db, ContactID);
            subsectorMWQMSampleYearService = new SubsectorMWQMSampleYearService(LanguageRequest, db, ContactID);
            searchTagAndTermsService = new SearchTagAndTermsService(LanguageRequest, db, ContactID);
            searchService = new SearchService(LanguageRequest, db, ContactID);
            rTBStringPosService = new RTBStringPosService(LanguageRequest, db, ContactID);
            polSourceObsInfoChildService = new PolSourceObsInfoChildService(LanguageRequest, db, ContactID);
            polSourceObsInfoEnumTextAndIDService = new PolSourceObsInfoEnumTextAndIDService(LanguageRequest, db, ContactID);
            polSourceInactiveReasonEnumTextAndIDService = new PolSourceInactiveReasonEnumTextAndIDService(LanguageRequest, db, ContactID);
            polyPointService = new PolyPointService(LanguageRequest, db, ContactID);
            otherFilesToUploadService = new OtherFilesToUploadService(LanguageRequest, db, ContactID);
            nodeLayerService = new NodeLayerService(LanguageRequest, db, ContactID);
            nodeService = new NodeService(LanguageRequest, db, ContactID);
            samplingPlanAndFilesLabSheetCountService = new SamplingPlanAndFilesLabSheetCountService(LanguageRequest, db, ContactID);
            mapObjService = new MapObjService(LanguageRequest, db, ContactID);
            latLngService = new LatLngService(LanguageRequest, db, ContactID);
            lastUpdateAndTVTextService = new LastUpdateAndTVTextService(LanguageRequest, db, ContactID);
            lastUpdateAndContactService = new LastUpdateAndContactService(LanguageRequest, db, ContactID);
            labSheetAndA1SheetService = new LabSheetAndA1SheetService(LanguageRequest, db, ContactID);
            labSheetA1MeasurementService = new LabSheetA1MeasurementService(LanguageRequest, db, ContactID);
            labSheetA1SheetService = new LabSheetA1SheetService(LanguageRequest, db, ContactID);
            inputSummaryService = new InputSummaryService(LanguageRequest, db, ContactID);
            filePurposeAndTextService = new FilePurposeAndTextService(LanguageRequest, db, ContactID);
            fileItemListService = new FileItemListService(LanguageRequest, db, ContactID);
            fileItemService = new FileItemService(LanguageRequest, db, ContactID);
            elementLayerService = new ElementLayerService(LanguageRequest, db, ContactID);
            elementService = new ElementService(LanguageRequest, db, ContactID);
            dataPathOfTideService = new DataPathOfTideService(LanguageRequest, db, ContactID);
            cSSPWQInputParamService = new CSSPWQInputParamService(LanguageRequest, db, ContactID);
            cSSPWQInputAppService = new CSSPWQInputAppService(LanguageRequest, db, ContactID);
            cSSPMPNTableService = new CSSPMPNTableService(LanguageRequest, db, ContactID);
            coordService = new CoordService(LanguageRequest, db, ContactID);
            contourPolygonService = new ContourPolygonService(LanguageRequest, db, ContactID);
            contactSearchService = new ContactSearchService(LanguageRequest, db, ContactID);
            contactOKService = new ContactOKService(LanguageRequest, db, ContactID);
            calDecayService = new CalDecayService(LanguageRequest, db, ContactID);
            dBTableService = new DBTableService(LanguageRequest, db, ContactID);
            boxModelCalNumbService = new BoxModelCalNumbService(LanguageRequest, db, ContactID);
            appTaskParameterService = new AppTaskParameterService(LanguageRequest, db, ContactID);
            appTaskLanguageService = new AppTaskLanguageService(LanguageRequest, db, ContactID);
            boxModelService = new BoxModelService(LanguageRequest, db, ContactID);
            boxModelLanguageService = new BoxModelLanguageService(LanguageRequest, db, ContactID);
            boxModelResultService = new BoxModelResultService(LanguageRequest, db, ContactID);
            climateDataValueService = new ClimateDataValueService(LanguageRequest, db, ContactID);
            climateSiteService = new ClimateSiteService(LanguageRequest, db, ContactID);
            contactLoginService = new ContactLoginService(LanguageRequest, db, ContactID);
            registerService = new RegisterService(LanguageRequest, db, ContactID);
            loginService = new LoginService(LanguageRequest, db, ContactID);
            contactService = new ContactService(LanguageRequest, db, ContactID);
            contactPreferenceService = new ContactPreferenceService(LanguageRequest, db, ContactID);
            contactShortcutService = new ContactShortcutService(LanguageRequest, db, ContactID);
            docTemplateService = new DocTemplateService(LanguageRequest, db, ContactID);
            emailService = new EmailService(LanguageRequest, db, ContactID);
            hydrometricDataValueService = new HydrometricDataValueService(LanguageRequest, db, ContactID);
            hydrometricSiteService = new HydrometricSiteService(LanguageRequest, db, ContactID);
            infrastructureService = new InfrastructureService(LanguageRequest, db, ContactID);
            infrastructureLanguageService = new InfrastructureLanguageService(LanguageRequest, db, ContactID);
            labSheetService = new LabSheetService(LanguageRequest, db, ContactID);
            labSheetDetailService = new LabSheetDetailService(LanguageRequest, db, ContactID);
            labSheetTubeMPNDetailService = new LabSheetTubeMPNDetailService(LanguageRequest, db, ContactID);
            logService = new LogService(LanguageRequest, db, ContactID);
            mapInfoService = new MapInfoService(LanguageRequest, db, ContactID);
            mapInfoPointService = new MapInfoPointService(LanguageRequest, db, ContactID);
            mikeBoundaryConditionService = new MikeBoundaryConditionService(LanguageRequest, db, ContactID);
            mikeScenarioService = new MikeScenarioService(LanguageRequest, db, ContactID);
            mikeSourceService = new MikeSourceService(LanguageRequest, db, ContactID);
            mikeSourceStartEndService = new MikeSourceStartEndService(LanguageRequest, db, ContactID);
            mwqmLookupMPNService = new MWQMLookupMPNService(LanguageRequest, db, ContactID);
            mwqmRunService = new MWQMRunService(LanguageRequest, db, ContactID);
            mwqmRunLanguageService = new MWQMRunLanguageService(LanguageRequest, db, ContactID);
            mwqmSampleService = new MWQMSampleService(LanguageRequest, db, ContactID);
            mwqmSampleLanguageService = new MWQMSampleLanguageService(LanguageRequest, db, ContactID);
            mwqmSiteService = new MWQMSiteService(LanguageRequest, db, ContactID);
            mwqmSiteStartEndDateService = new MWQMSiteStartEndDateService(LanguageRequest, db, ContactID);
            mwqmSubsectorService = new MWQMSubsectorService(LanguageRequest, db, ContactID);
            mwqmSubsectorLanguageService = new MWQMSubsectorLanguageService(LanguageRequest, db, ContactID);
            polSourceObservationService = new PolSourceObservationService(LanguageRequest, db, ContactID);
            polSourceObservationIssueService = new PolSourceObservationIssueService(LanguageRequest, db, ContactID);
            polSourceSiteService = new PolSourceSiteService(LanguageRequest, db, ContactID);
            ratingCurveService = new RatingCurveService(LanguageRequest, db, ContactID);
            ratingCurveValueService = new RatingCurveValueService(LanguageRequest, db, ContactID);
            resetPasswordService = new ResetPasswordService(LanguageRequest, db, ContactID);
            samplingPlanService = new SamplingPlanService(LanguageRequest, db, ContactID);
            samplingPlanSubsectorService = new SamplingPlanSubsectorService(LanguageRequest, db, ContactID);
            samplingPlanSubsectorSiteService = new SamplingPlanSubsectorSiteService(LanguageRequest, db, ContactID);
            spillService = new SpillService(LanguageRequest, db, ContactID);
            spillLanguageService = new SpillLanguageService(LanguageRequest, db, ContactID);
            telService = new TelService(LanguageRequest, db, ContactID);
            tideDataValueService = new TideDataValueService(LanguageRequest, db, ContactID);
            tideLocationService = new TideLocationService(LanguageRequest, db, ContactID);
            tideSiteService = new TideSiteService(LanguageRequest, db, ContactID);
            tvFileService = new TVFileService(LanguageRequest, db, ContactID);
            tvFileLanguageService = new TVFileLanguageService(LanguageRequest, db, ContactID);
            tvItemService = new TVItemService(LanguageRequest, db, ContactID);
            tvItemLanguageService = new TVItemLanguageService(LanguageRequest, db, ContactID);
            tvItemLinkService = new TVItemLinkService(LanguageRequest, db, ContactID);
            tvItemStatService = new TVItemStatService(LanguageRequest, db, ContactID);
            tvItemUserAuthorizationService = new TVItemUserAuthorizationService(LanguageRequest, db, ContactID);
            tvTypeUserAuthorizationService = new TVTypeUserAuthorizationService(LanguageRequest, db, ContactID);
            useOfSiteService = new UseOfSiteService(LanguageRequest, db, ContactID);
            vpAmbientService = new VPAmbientService(LanguageRequest, db, ContactID);
            vpResultService = new VPResultService(LanguageRequest, db, ContactID);
            vpScenarioService = new VPScenarioService(LanguageRequest, db, ContactID);
            vpScenarioLanguageService = new VPScenarioLanguageService(LanguageRequest, db, ContactID);
        }
