...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillInfrastructureExtraB
        private IQueryable<InfrastructureExtraB> FillInfrastructureExtraB()
        {
            ...
            List<EnumIDAndText> AlarmSystemTypeEnumList = enums.GetEnumTextOrderedList(typeof(AlarmSystemTypeEnum));
             ...
             IQueryable<InfrastructureExtraB> InfrastructureExtraBQuery = (from c in db.Infrastructures
                let InfrastructureReportTest = (from cl in db.TVItemLanguages
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new InfrastructureExtraB
                    {
        ...
        #endregion Functions private Generated FillInfrastructureExtraB
