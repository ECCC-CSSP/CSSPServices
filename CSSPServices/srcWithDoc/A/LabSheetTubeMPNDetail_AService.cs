...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillLabSheetTubeMPNDetail_A
        private IQueryable<LabSheetTubeMPNDetail_A> FillLabSheetTubeMPNDetail_A()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> SampleTypeEnumList = enums.GetEnumTextOrderedList(typeof(SampleTypeEnum));

             IQueryable<LabSheetTubeMPNDetail_A> LabSheetTubeMPNDetail_AQuery = (from c in db.LabSheetTubeMPNDetails
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new LabSheetTubeMPNDetail_A
                    {
        ...
        #endregion Functions private Generated FillLabSheetTubeMPNDetail_A
