...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated MWQMSubsectorLanguageFillReport
        private IQueryable<MWQMSubsectorLanguageReport> FillMWQMSubsectorLanguageReport()
        {
            ...
            List<EnumIDAndText> TranslationStatusEnumList = enums.GetEnumTextOrderedList(typeof(TranslationStatusEnum));
             ...
             IQueryable<MWQMSubsectorLanguageReport>  MWQMSubsectorLanguageReportQuery = (from c in db.MWQMSubsectorLanguages
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MWQMSubsectorLanguageReport
                    {
                        MWQMSubsectorLanguageReportTest = "Testing Report",
        ...
        #endregion Functions private Generated MWQMSubsectorLanguageFillReport
