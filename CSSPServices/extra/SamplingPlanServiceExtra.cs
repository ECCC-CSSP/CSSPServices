...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated SamplingPlanFillReport
        private IQueryable<SamplingPlanReport> FillSamplingPlanReport()
        {
            ...
            List<EnumIDAndText> LabSheetTypeEnumList = enums.GetEnumTextOrderedList(typeof(LabSheetTypeEnum));
             ...
             IQueryable<SamplingPlanReport>  SamplingPlanReportQuery = (from c in db.SamplingPlans
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new SamplingPlanReport
                    {
                        SamplingPlanReportTest = "Testing Report",
        ...
        #endregion Functions private Generated SamplingPlanFillReport
