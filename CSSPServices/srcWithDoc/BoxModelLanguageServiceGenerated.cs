...
namespace CSSPServices
{
    ...
    public partial class BoxModelLanguageService : BaseService
    {
        ...
        /// <summary>
        /// Gets the BoxModelLanguageExtraA model with the BoxModelLanguageID identifier
        /// </summary>
        /// <param name="BoxModelLanguageID">Is the identifier of [BoxModelLanguages](CSSPModels.BoxModelLanguage.html) table of CSSPDB</param>
        /// <returns>[BoxModelLanguageExtraA](CSSPModels.BoxModelLanguageExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [BoxModelLanguageExtraA](CSSPModels.BoxModelLanguageExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [BoxModelLanguageExtraA](CSSPModels.BoxModelLanguageExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the BoxModelLanguageExtraB model with the BoxModelLanguageID identifier
        /// </summary>
        /// <param name="BoxModelLanguageID">Is the identifier of [BoxModelLanguages](CSSPModels.BoxModelLanguage.html) table of CSSPDB</param>
        /// <returns>[BoxModelLanguageExtraB](CSSPModels.BoxModelLanguageExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [BoxModelLanguageExtraB](CSSPModels.BoxModelLanguageExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [BoxModelLanguageExtraB](CSSPModels.BoxModelLanguageExtraB.html)</returns>
