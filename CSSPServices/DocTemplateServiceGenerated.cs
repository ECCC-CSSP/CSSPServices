...
namespace CSSPServices
{
    public partial class DocTemplateService : BaseService
    {
        ...
        #region Constructors
        public DocTemplateService(LanguageEnum LanguageRequest, IPrincipal User, DatabaseTypeEnum DatabaseType)
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (docTemplate.LastUpdateDate_UTC == null || docTemplate.LastUpdateDate_UTC.Year < 1900 )
            {
