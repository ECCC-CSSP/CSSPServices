...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated LabSheetDetailFillReport
        private IQueryable<LabSheetDetailReport> FillLabSheetDetailReport()
        {
             IQueryable<LabSheetDetailReport>  LabSheetDetailReportQuery = (from c in db.LabSheetDetails
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new LabSheetDetailReport
                    {
                        LabSheetDetailReportTest = "Testing Report",
        ...
        #endregion Functions private Generated LabSheetDetailFillReport
