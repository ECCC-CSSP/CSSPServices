...
namespace CSSPServices.Tests
{
    ...
    public partial class PolSourceSiteServiceTest : TestHelper
    {
        ...
        private PolSourceSite GetFilledRandomPolSourceSite(string OmitPropName)
        {
            ...
            if (OmitPropName != "PolSourceSiteTVItemID") polSourceSite.PolSourceSiteTVItemID = 22;
            ...
            if (OmitPropName != "CivicAddressTVItemID") polSourceSite.CivicAddressTVItemID = 21;
