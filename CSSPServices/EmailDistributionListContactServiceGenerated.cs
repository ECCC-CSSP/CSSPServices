...
namespace CSSPServices
{
    public partial class EmailDistributionListContactService : BaseService
    {
        ...
        #region Constructors
        public EmailDistributionListContactService(LanguageEnum LanguageRequest, int ContactID, DatabaseTypeEnum DatabaseType)
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (emailDistributionListContact.LastUpdateDate_UTC == null)
            {
