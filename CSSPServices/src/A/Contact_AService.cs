...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillContact_A
        private IQueryable<Contact_A> FillContact_A()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> ContactTitleEnumList = enums.GetEnumTextOrderedList(typeof(ContactTitleEnum));

             IQueryable<Contact_A> Contact_AQuery = (from c in db.Contacts
        ...
        #endregion Functions private Generated FillContact_A
