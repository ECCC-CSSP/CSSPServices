...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillContact_B
        private IQueryable<Contact_B> FillContact_B()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> ContactTitleEnumList = enums.GetEnumTextOrderedList(typeof(ContactTitleEnum));

             IQueryable<Contact_B> Contact_BQuery = (from c in db.Contacts
        ...
        #endregion Functions private Generated FillContact_B
