...
namespace CSSPServices
{
    ...
    public partial class InfrastructureLanguageService : BaseService
    {
        ...
        /// <summary>
        /// Gets the InfrastructureLanguageExtraA model with the InfrastructureLanguageID identifier
        /// </summary>
        /// <param name="InfrastructureLanguageID">Is the identifier of [InfrastructureLanguages](CSSPModels.InfrastructureLanguage.html) table of CSSPDB</param>
        /// <returns>[InfrastructureLanguageExtraA](CSSPModels.InfrastructureLanguageExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [InfrastructureLanguageExtraA](CSSPModels.InfrastructureLanguageExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [InfrastructureLanguageExtraA](CSSPModels.InfrastructureLanguageExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the InfrastructureLanguageExtraB model with the InfrastructureLanguageID identifier
        /// </summary>
        /// <param name="InfrastructureLanguageID">Is the identifier of [InfrastructureLanguages](CSSPModels.InfrastructureLanguage.html) table of CSSPDB</param>
        /// <returns>[InfrastructureLanguageExtraB](CSSPModels.InfrastructureLanguageExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [InfrastructureLanguageExtraB](CSSPModels.InfrastructureLanguageExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [InfrastructureLanguageExtraB](CSSPModels.InfrastructureLanguageExtraB.html)</returns>
