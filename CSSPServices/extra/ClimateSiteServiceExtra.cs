...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated ClimateSiteFillReport
        private IQueryable<ClimateSiteReport> FillClimateSiteReport()
        {
             IQueryable<ClimateSiteReport>  ClimateSiteReportQuery = (from c in db.ClimateSites
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new ClimateSiteReport
                    {
                        ClimateSiteReportTest = "Testing Report",
        ...
        #endregion Functions private Generated ClimateSiteFillReport
