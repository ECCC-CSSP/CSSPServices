...
namespace CSSPServices.Tests
{
    ...
    public partial class ElementTest : TestHelper
    {
        ...
        private Element GetFilledRandomElement(string OmitPropName)
        {
            ...
            if (OmitPropName != "Value") element.Value = GetRandomFloat(1.0f, 5.0f);
            if (OmitPropName != "XNode0") element.XNode0 = GetRandomFloat(1.0f, 5.0f);
            if (OmitPropName != "YNode0") element.YNode0 = GetRandomFloat(1.0f, 5.0f);
            if (OmitPropName != "ZNode0") element.ZNode0 = GetRandomFloat(1.0f, 5.0f);
