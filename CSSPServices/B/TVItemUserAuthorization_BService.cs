...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillTVItemUserAuthorization_B
        private IQueryable<TVItemUserAuthorization_B> FillTVItemUserAuthorization_B()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> TVAuthEnumList = enums.GetEnumTextOrderedList(typeof(TVAuthEnum));

             IQueryable<TVItemUserAuthorization_B> TVItemUserAuthorization_BQuery = (from c in db.TVItemUserAuthorizations
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new TVItemUserAuthorization_B
                    {
        ...
        #endregion Functions private Generated FillTVItemUserAuthorization_B
