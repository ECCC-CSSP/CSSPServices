...
namespace CSSPServices
{
    ...
    public partial class ContactShortcutService : BaseService
    {
        ...
        /// <summary>
        /// Gets the ContactShortcutExtraA model with the ContactShortcutID identifier
        /// </summary>
        /// <param name="ContactShortcutID">Is the identifier of [ContactShortcuts](CSSPModels.ContactShortcut.html) table of CSSPDB</param>
        /// <returns>[ContactShortcutExtraA](CSSPModels.ContactShortcutExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [ContactShortcutExtraA](CSSPModels.ContactShortcutExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [ContactShortcutExtraA](CSSPModels.ContactShortcutExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the ContactShortcutExtraB model with the ContactShortcutID identifier
        /// </summary>
        /// <param name="ContactShortcutID">Is the identifier of [ContactShortcuts](CSSPModels.ContactShortcut.html) table of CSSPDB</param>
        /// <returns>[ContactShortcutExtraB](CSSPModels.ContactShortcutExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [ContactShortcutExtraB](CSSPModels.ContactShortcutExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [ContactShortcutExtraB](CSSPModels.ContactShortcutExtraB.html)</returns>
