...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillInfrastructure_A
        private IQueryable<Infrastructure_A> FillInfrastructure_A()
        {
            ...
            List<EnumIDAndText> AlarmSystemTypeEnumList = enums.GetEnumTextOrderedList(typeof(AlarmSystemTypeEnum));
             ...
             IQueryable<Infrastructure_A> Infrastructure_AQuery = (from c in db.Infrastructures
        ...
        #endregion Functions private Generated FillInfrastructure_A
