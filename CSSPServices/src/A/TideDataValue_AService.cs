...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillTideDataValue_A
        private IQueryable<TideDataValue_A> FillTideDataValue_A()
        {
            ...
            List<EnumIDAndText> TideTextEnumList = enums.GetEnumTextOrderedList(typeof(TideTextEnum));
             ...
             IQueryable<TideDataValue_A> TideDataValue_AQuery = (from c in db.TideDataValues
        ...
        #endregion Functions private Generated FillTideDataValue_A
