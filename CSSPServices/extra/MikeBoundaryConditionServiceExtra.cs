...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated MikeBoundaryConditionFillReport
        private IQueryable<MikeBoundaryConditionReport> FillMikeBoundaryConditionReport()
        {
            ...
            List<EnumIDAndText> TVTypeEnumList = enums.GetEnumTextOrderedList(typeof(TVTypeEnum));
             ...
             IQueryable<MikeBoundaryConditionReport>  MikeBoundaryConditionReportQuery = (from c in db.MikeBoundaryConditions
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MikeBoundaryConditionReport
                    {
                        MikeBoundaryConditionReportTest = "Testing Report",
        ...
        #endregion Functions private Generated MikeBoundaryConditionFillReport
