...
namespace CSSPServices
{
    public partial class TVTypeNamesAndPathService : BaseService
    {
        ...
        #region Constructors
        public TVTypeNamesAndPathService(LanguageEnum LanguageRequest, int ContactID, DatabaseTypeEnum DatabaseType)
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            //Index is required but no testing needed as it is automatically set to 0
