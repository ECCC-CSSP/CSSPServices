...
namespace CSSPServices
{
    ...
    public partial class SamplingPlanSubsectorSiteService : BaseService
    {
        ...
        /// <summary>
        /// Gets the SamplingPlanSubsectorSiteExtraA model with the SamplingPlanSubsectorSiteID identifier
        /// </summary>
        /// <param name="SamplingPlanSubsectorSiteID">Is the identifier of [SamplingPlanSubsectorSites](CSSPModels.SamplingPlanSubsectorSite.html) table of CSSPDB</param>
        /// <returns>[SamplingPlanSubsectorSiteExtraA](CSSPModels.SamplingPlanSubsectorSiteExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SamplingPlanSubsectorSiteExtraA](CSSPModels.SamplingPlanSubsectorSiteExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SamplingPlanSubsectorSiteExtraA](CSSPModels.SamplingPlanSubsectorSiteExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the SamplingPlanSubsectorSiteExtraB model with the SamplingPlanSubsectorSiteID identifier
        /// </summary>
        /// <param name="SamplingPlanSubsectorSiteID">Is the identifier of [SamplingPlanSubsectorSites](CSSPModels.SamplingPlanSubsectorSite.html) table of CSSPDB</param>
        /// <returns>[SamplingPlanSubsectorSiteExtraB](CSSPModels.SamplingPlanSubsectorSiteExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SamplingPlanSubsectorSiteExtraB](CSSPModels.SamplingPlanSubsectorSiteExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SamplingPlanSubsectorSiteExtraB](CSSPModels.SamplingPlanSubsectorSiteExtraB.html)</returns>
