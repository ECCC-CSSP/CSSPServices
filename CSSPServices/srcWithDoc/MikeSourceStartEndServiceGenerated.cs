...
namespace CSSPServices
{
    ...
    public partial class MikeSourceStartEndService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MikeSourceStartEndExtraA model with the MikeSourceStartEndID identifier
        /// </summary>
        /// <param name="MikeSourceStartEndID">Is the identifier of [MikeSourceStartEnds](CSSPModels.MikeSourceStartEnd.html) table of CSSPDB</param>
        /// <returns>[MikeSourceStartEndExtraA](CSSPModels.MikeSourceStartEndExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeSourceStartEndExtraA](CSSPModels.MikeSourceStartEndExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeSourceStartEndExtraA](CSSPModels.MikeSourceStartEndExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MikeSourceStartEndExtraB model with the MikeSourceStartEndID identifier
        /// </summary>
        /// <param name="MikeSourceStartEndID">Is the identifier of [MikeSourceStartEnds](CSSPModels.MikeSourceStartEnd.html) table of CSSPDB</param>
        /// <returns>[MikeSourceStartEndExtraB](CSSPModels.MikeSourceStartEndExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeSourceStartEndExtraB](CSSPModels.MikeSourceStartEndExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeSourceStartEndExtraB](CSSPModels.MikeSourceStartEndExtraB.html)</returns>
