...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillReportTypeLanguage_A
        private IQueryable<ReportTypeLanguage_A> FillReportTypeLanguage_A()
        {
            ...
            List<EnumIDAndText> TranslationStatusEnumList = enums.GetEnumTextOrderedList(typeof(TranslationStatusEnum));
             ...
             IQueryable<ReportTypeLanguage_A> ReportTypeLanguage_AQuery = (from c in db.ReportTypeLanguages
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new ReportTypeLanguage_A
                    {
        ...
        #endregion Functions private Generated FillReportTypeLanguage_A
