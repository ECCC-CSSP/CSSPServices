...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMWQMAnalysisReportParameter_B
        private IQueryable<MWQMAnalysisReportParameter_B> FillMWQMAnalysisReportParameter_B()
        {
            ...
            List<EnumIDAndText> AnalysisReportExportCommandEnumList = enums.GetEnumTextOrderedList(typeof(AnalysisReportExportCommandEnum));
             ...
             IQueryable<MWQMAnalysisReportParameter_B> MWQMAnalysisReportParameter_BQuery = (from c in db.MWQMAnalysisReportParameters
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MWQMAnalysisReportParameter_B
                    {
        ...
        #endregion Functions private Generated FillMWQMAnalysisReportParameter_B
