...
namespace CSSPServices
{
    ...
    public partial class RatingCurveValueService : BaseService
    {
        ...
        /// <summary>
        /// Gets the RatingCurveValueExtraA model with the RatingCurveValueID identifier
        /// </summary>
        /// <param name="RatingCurveValueID">Is the identifier of [RatingCurveValues](CSSPModels.RatingCurveValue.html) table of CSSPDB</param>
        /// <returns>[RatingCurveValueExtraA](CSSPModels.RatingCurveValueExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [RatingCurveValueExtraA](CSSPModels.RatingCurveValueExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [RatingCurveValueExtraA](CSSPModels.RatingCurveValueExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the RatingCurveValueExtraB model with the RatingCurveValueID identifier
        /// </summary>
        /// <param name="RatingCurveValueID">Is the identifier of [RatingCurveValues](CSSPModels.RatingCurveValue.html) table of CSSPDB</param>
        /// <returns>[RatingCurveValueExtraB](CSSPModels.RatingCurveValueExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [RatingCurveValueExtraB](CSSPModels.RatingCurveValueExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [RatingCurveValueExtraB](CSSPModels.RatingCurveValueExtraB.html)</returns>
