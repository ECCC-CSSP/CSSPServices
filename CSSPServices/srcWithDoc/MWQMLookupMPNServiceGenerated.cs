...
namespace CSSPServices
{
    ...
    public partial class MWQMLookupMPNService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MWQMLookupMPNExtraA model with the MWQMLookupMPNID identifier
        /// </summary>
        /// <param name="MWQMLookupMPNID">Is the identifier of [MWQMLookupMPNs](CSSPModels.MWQMLookupMPN.html) table of CSSPDB</param>
        /// <returns>[MWQMLookupMPNExtraA](CSSPModels.MWQMLookupMPNExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMLookupMPNExtraA](CSSPModels.MWQMLookupMPNExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMLookupMPNExtraA](CSSPModels.MWQMLookupMPNExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MWQMLookupMPNExtraB model with the MWQMLookupMPNID identifier
        /// </summary>
        /// <param name="MWQMLookupMPNID">Is the identifier of [MWQMLookupMPNs](CSSPModels.MWQMLookupMPN.html) table of CSSPDB</param>
        /// <returns>[MWQMLookupMPNExtraB](CSSPModels.MWQMLookupMPNExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMLookupMPNExtraB](CSSPModels.MWQMLookupMPNExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMLookupMPNExtraB](CSSPModels.MWQMLookupMPNExtraB.html)</returns>
