...
namespace CSSPServices
{
    ...
    public partial class SamplingPlanSubsectorService : BaseService
    {
        ...
        /// <summary>
        /// Gets the SamplingPlanSubsectorExtraA model with the SamplingPlanSubsectorID identifier
        /// </summary>
        /// <param name="SamplingPlanSubsectorID">Is the identifier of [SamplingPlanSubsectors](CSSPModels.SamplingPlanSubsector.html) table of CSSPDB</param>
        /// <returns>[SamplingPlanSubsectorExtraA](CSSPModels.SamplingPlanSubsectorExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SamplingPlanSubsectorExtraA](CSSPModels.SamplingPlanSubsectorExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SamplingPlanSubsectorExtraA](CSSPModels.SamplingPlanSubsectorExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the SamplingPlanSubsectorExtraB model with the SamplingPlanSubsectorID identifier
        /// </summary>
        /// <param name="SamplingPlanSubsectorID">Is the identifier of [SamplingPlanSubsectors](CSSPModels.SamplingPlanSubsector.html) table of CSSPDB</param>
        /// <returns>[SamplingPlanSubsectorExtraB](CSSPModels.SamplingPlanSubsectorExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SamplingPlanSubsectorExtraB](CSSPModels.SamplingPlanSubsectorExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SamplingPlanSubsectorExtraB](CSSPModels.SamplingPlanSubsectorExtraB.html)</returns>
