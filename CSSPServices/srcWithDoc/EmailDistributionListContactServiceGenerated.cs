...
namespace CSSPServices
{
    ...
    public partial class EmailDistributionListContactService : BaseService
    {
        ...
        /// <summary>
        /// Gets the EmailDistributionListContactExtraA model with the EmailDistributionListContactID identifier
        /// </summary>
        /// <param name="EmailDistributionListContactID">Is the identifier of [EmailDistributionListContacts](CSSPModels.EmailDistributionListContact.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListContactExtraA](CSSPModels.EmailDistributionListContactExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListContactExtraA](CSSPModels.EmailDistributionListContactExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListContactExtraA](CSSPModels.EmailDistributionListContactExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the EmailDistributionListContactExtraB model with the EmailDistributionListContactID identifier
        /// </summary>
        /// <param name="EmailDistributionListContactID">Is the identifier of [EmailDistributionListContacts](CSSPModels.EmailDistributionListContact.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListContactExtraB](CSSPModels.EmailDistributionListContactExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListContactExtraB](CSSPModels.EmailDistributionListContactExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListContactExtraB](CSSPModels.EmailDistributionListContactExtraB.html)</returns>
