...
namespace CSSPServices
{
    public partial class EmailDistributionListService : BaseService
    {
        ...
        #region Constructors
        public EmailDistributionListService(LanguageEnum LanguageRequest, int ContactID, DatabaseTypeEnum DatabaseType)
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (emailDistributionList.LastUpdateDate_UTC == null)
            {
