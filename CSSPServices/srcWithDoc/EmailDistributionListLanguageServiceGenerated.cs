...
namespace CSSPServices
{
    ...
    public partial class EmailDistributionListLanguageService : BaseService
    {
        ...
        /// <summary>
        /// Gets the EmailDistributionListLanguageExtraA model with the EmailDistributionListLanguageID identifier
        /// </summary>
        /// <param name="EmailDistributionListLanguageID">Is the identifier of [EmailDistributionListLanguages](CSSPModels.EmailDistributionListLanguage.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListLanguageExtraA](CSSPModels.EmailDistributionListLanguageExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListLanguageExtraA](CSSPModels.EmailDistributionListLanguageExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListLanguageExtraA](CSSPModels.EmailDistributionListLanguageExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the EmailDistributionListLanguageExtraB model with the EmailDistributionListLanguageID identifier
        /// </summary>
        /// <param name="EmailDistributionListLanguageID">Is the identifier of [EmailDistributionListLanguages](CSSPModels.EmailDistributionListLanguage.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListLanguageExtraB](CSSPModels.EmailDistributionListLanguageExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListLanguageExtraB](CSSPModels.EmailDistributionListLanguageExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListLanguageExtraB](CSSPModels.EmailDistributionListLanguageExtraB.html)</returns>
