...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillVPAmbient_A
        private IQueryable<VPAmbient_A> FillVPAmbient_A()
        {
             IQueryable<VPAmbient_A> VPAmbient_AQuery = (from c in db.VPAmbients
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new VPAmbient_A
                    {
        ...
        #endregion Functions private Generated FillVPAmbient_A
