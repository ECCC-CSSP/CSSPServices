...
namespace CSSPServices
{
    ...
    public partial class PolSourceObservationIssueService : BaseService
    {
        ...
        /// <summary>
        /// Gets the PolSourceObservationIssueExtraA model with the PolSourceObservationIssueID identifier
        /// </summary>
        /// <param name="PolSourceObservationIssueID">Is the identifier of [PolSourceObservationIssues](CSSPModels.PolSourceObservationIssue.html) table of CSSPDB</param>
        /// <returns>[PolSourceObservationIssueExtraA](CSSPModels.PolSourceObservationIssueExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [PolSourceObservationIssueExtraA](CSSPModels.PolSourceObservationIssueExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [PolSourceObservationIssueExtraA](CSSPModels.PolSourceObservationIssueExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the PolSourceObservationIssueExtraB model with the PolSourceObservationIssueID identifier
        /// </summary>
        /// <param name="PolSourceObservationIssueID">Is the identifier of [PolSourceObservationIssues](CSSPModels.PolSourceObservationIssue.html) table of CSSPDB</param>
        /// <returns>[PolSourceObservationIssueExtraB](CSSPModels.PolSourceObservationIssueExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [PolSourceObservationIssueExtraB](CSSPModels.PolSourceObservationIssueExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [PolSourceObservationIssueExtraB](CSSPModels.PolSourceObservationIssueExtraB.html)</returns>
