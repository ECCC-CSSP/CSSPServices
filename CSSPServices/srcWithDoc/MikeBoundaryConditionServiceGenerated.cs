...
namespace CSSPServices
{
    ...
    public partial class MikeBoundaryConditionService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MikeBoundaryConditionExtraA model with the MikeBoundaryConditionID identifier
        /// </summary>
        /// <param name="MikeBoundaryConditionID">Is the identifier of [MikeBoundaryConditions](CSSPModels.MikeBoundaryCondition.html) table of CSSPDB</param>
        /// <returns>[MikeBoundaryConditionExtraA](CSSPModels.MikeBoundaryConditionExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeBoundaryConditionExtraA](CSSPModels.MikeBoundaryConditionExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeBoundaryConditionExtraA](CSSPModels.MikeBoundaryConditionExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MikeBoundaryConditionExtraB model with the MikeBoundaryConditionID identifier
        /// </summary>
        /// <param name="MikeBoundaryConditionID">Is the identifier of [MikeBoundaryConditions](CSSPModels.MikeBoundaryCondition.html) table of CSSPDB</param>
        /// <returns>[MikeBoundaryConditionExtraB](CSSPModels.MikeBoundaryConditionExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeBoundaryConditionExtraB](CSSPModels.MikeBoundaryConditionExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeBoundaryConditionExtraB](CSSPModels.MikeBoundaryConditionExtraB.html)</returns>
