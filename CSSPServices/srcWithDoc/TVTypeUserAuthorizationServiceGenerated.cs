...
namespace CSSPServices
{
    ...
    public partial class TVTypeUserAuthorizationService : BaseService
    {
        ...
        /// <summary>
        /// Gets the TVTypeUserAuthorizationExtraA model with the TVTypeUserAuthorizationID identifier
        /// </summary>
        /// <param name="TVTypeUserAuthorizationID">Is the identifier of [TVTypeUserAuthorizations](CSSPModels.TVTypeUserAuthorization.html) table of CSSPDB</param>
        /// <returns>[TVTypeUserAuthorizationExtraA](CSSPModels.TVTypeUserAuthorizationExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TVTypeUserAuthorizationExtraA](CSSPModels.TVTypeUserAuthorizationExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TVTypeUserAuthorizationExtraA](CSSPModels.TVTypeUserAuthorizationExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the TVTypeUserAuthorizationExtraB model with the TVTypeUserAuthorizationID identifier
        /// </summary>
        /// <param name="TVTypeUserAuthorizationID">Is the identifier of [TVTypeUserAuthorizations](CSSPModels.TVTypeUserAuthorization.html) table of CSSPDB</param>
        /// <returns>[TVTypeUserAuthorizationExtraB](CSSPModels.TVTypeUserAuthorizationExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TVTypeUserAuthorizationExtraB](CSSPModels.TVTypeUserAuthorizationExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TVTypeUserAuthorizationExtraB](CSSPModels.TVTypeUserAuthorizationExtraB.html)</returns>
