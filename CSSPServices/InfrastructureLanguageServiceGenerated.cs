...
namespace CSSPServices
{
    public partial class InfrastructureLanguageService : BaseService
    {
        ...
        #region Constructors
        public InfrastructureLanguageService(LanguageEnum LanguageRequest, int ContactID, DatabaseTypeEnum DatabaseType)
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (infrastructureLanguage.LastUpdateDate_UTC == null)
            {
