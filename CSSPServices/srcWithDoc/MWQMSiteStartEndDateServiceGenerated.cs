...
namespace CSSPServices
{
    ...
    public partial class MWQMSiteStartEndDateService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MWQMSiteStartEndDateExtraA model with the MWQMSiteStartEndDateID identifier
        /// </summary>
        /// <param name="MWQMSiteStartEndDateID">Is the identifier of [MWQMSiteStartEndDates](CSSPModels.MWQMSiteStartEndDate.html) table of CSSPDB</param>
        /// <returns>[MWQMSiteStartEndDateExtraA](CSSPModels.MWQMSiteStartEndDateExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMSiteStartEndDateExtraA](CSSPModels.MWQMSiteStartEndDateExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMSiteStartEndDateExtraA](CSSPModels.MWQMSiteStartEndDateExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MWQMSiteStartEndDateExtraB model with the MWQMSiteStartEndDateID identifier
        /// </summary>
        /// <param name="MWQMSiteStartEndDateID">Is the identifier of [MWQMSiteStartEndDates](CSSPModels.MWQMSiteStartEndDate.html) table of CSSPDB</param>
        /// <returns>[MWQMSiteStartEndDateExtraB](CSSPModels.MWQMSiteStartEndDateExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMSiteStartEndDateExtraB](CSSPModels.MWQMSiteStartEndDateExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMSiteStartEndDateExtraB](CSSPModels.MWQMSiteStartEndDateExtraB.html)</returns>
