...
namespace CSSPServices
{
    ...
    public partial class DocTemplateService : BaseService
    {
        ...
        /// <summary>
        /// Gets the DocTemplateExtraA model with the DocTemplateID identifier
        /// </summary>
        /// <param name="DocTemplateID">Is the identifier of [DocTemplates](CSSPModels.DocTemplate.html) table of CSSPDB</param>
        /// <returns>[DocTemplateExtraA](CSSPModels.DocTemplateExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [DocTemplateExtraA](CSSPModels.DocTemplateExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [DocTemplateExtraA](CSSPModels.DocTemplateExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the DocTemplateExtraB model with the DocTemplateID identifier
        /// </summary>
        /// <param name="DocTemplateID">Is the identifier of [DocTemplates](CSSPModels.DocTemplate.html) table of CSSPDB</param>
        /// <returns>[DocTemplateExtraB](CSSPModels.DocTemplateExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [DocTemplateExtraB](CSSPModels.DocTemplateExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [DocTemplateExtraB](CSSPModels.DocTemplateExtraB.html)</returns>
