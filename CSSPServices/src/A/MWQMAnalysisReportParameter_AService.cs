...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMWQMAnalysisReportParameter_A
        private IQueryable<MWQMAnalysisReportParameter_A> FillMWQMAnalysisReportParameter_A()
        {
            ...
            List<EnumIDAndText> AnalysisReportExportCommandEnumList = enums.GetEnumTextOrderedList(typeof(AnalysisReportExportCommandEnum));
             ...
             IQueryable<MWQMAnalysisReportParameter_A> MWQMAnalysisReportParameter_AQuery = (from c in db.MWQMAnalysisReportParameters
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MWQMAnalysisReportParameter_A
                    {
        ...
        #endregion Functions private Generated FillMWQMAnalysisReportParameter_A
