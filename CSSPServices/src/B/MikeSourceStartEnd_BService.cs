...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMikeSourceStartEnd_B
        private IQueryable<MikeSourceStartEnd_B> FillMikeSourceStartEnd_B()
        {
             IQueryable<MikeSourceStartEnd_B> MikeSourceStartEnd_BQuery = (from c in db.MikeSourceStartEnds
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    select new MikeSourceStartEnd_B
                    {
        ...
        #endregion Functions private Generated FillMikeSourceStartEnd_B
