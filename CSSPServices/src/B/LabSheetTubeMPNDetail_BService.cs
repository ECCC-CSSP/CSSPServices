...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillLabSheetTubeMPNDetail_B
        private IQueryable<LabSheetTubeMPNDetail_B> FillLabSheetTubeMPNDetail_B()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> SampleTypeEnumList = enums.GetEnumTextOrderedList(typeof(SampleTypeEnum));

             IQueryable<LabSheetTubeMPNDetail_B> LabSheetTubeMPNDetail_BQuery = (from c in db.LabSheetTubeMPNDetails
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new LabSheetTubeMPNDetail_B
                    {
        ...
        #endregion Functions private Generated FillLabSheetTubeMPNDetail_B
