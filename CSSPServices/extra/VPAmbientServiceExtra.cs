...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated VPAmbientFillReport
        private IQueryable<VPAmbientReport> FillVPAmbientReport()
        {
             IQueryable<VPAmbientReport>  VPAmbientReportQuery = (from c in db.VPAmbients
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new VPAmbientReport
                    {
                        VPAmbientReportTest = "Testing Report",
        ...
        #endregion Functions private Generated VPAmbientFillReport
