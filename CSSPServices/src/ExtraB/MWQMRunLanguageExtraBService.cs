...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMWQMRunLanguageExtraB
        private IQueryable<MWQMRunLanguageExtraB> FillMWQMRunLanguageExtraB()
        {
            ...
            List<EnumIDAndText> TranslationStatusEnumList = enums.GetEnumTextOrderedList(typeof(TranslationStatusEnum));
             ...
             IQueryable<MWQMRunLanguageExtraB> MWQMRunLanguageExtraBQuery = (from c in db.MWQMRunLanguages
                ...
                let TranslationStatusRunWeatherCommentText = (from e in TranslationStatusEnumList
                    ...
                    select e.EnumText).FirstOrDefault()
                    select new MWQMRunLanguageExtraB
                    {
        ...
        #endregion Functions private Generated FillMWQMRunLanguageExtraB
