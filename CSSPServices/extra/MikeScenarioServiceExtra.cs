...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated MikeScenarioFillReport
        private IQueryable<MikeScenarioReport> FillMikeScenarioReport()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> ScenarioStatusEnumList = enums.GetEnumTextOrderedList(typeof(ScenarioStatusEnum));

             IQueryable<MikeScenarioReport>  MikeScenarioReportQuery = (from c in db.MikeScenarios
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MikeScenarioReport
                    {
                        MikeScenarioReportTest = "Testing Report",
        ...
        #endregion Functions private Generated MikeScenarioFillReport
