...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated TVItemLinkFillReport
        private IQueryable<TVItemLinkReport> FillTVItemLinkReport()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> TVTypeEnumList = enums.GetEnumTextOrderedList(typeof(TVTypeEnum));

             IQueryable<TVItemLinkReport>  TVItemLinkReportQuery = (from c in db.TVItemLinks
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new TVItemLinkReport
                    {
                        TVItemLinkReportTest = "Testing Report",
        ...
        #endregion Functions private Generated TVItemLinkFillReport
