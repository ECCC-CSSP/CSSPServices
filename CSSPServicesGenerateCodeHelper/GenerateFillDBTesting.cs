...
namespace CSSPServicesGenerateCodeHelper
{
    public partial class GenerateFillDBTesting
    {
        ...
        public void GenerateCodeOf__FillDBTestGenerated()
        {
            ...
            sb.AppendLine(@"            contact.LoginEmail = ""aaaaaa"";");
            sb.AppendLine(@"");
            sb.AppendLine(@"            byte[] PasswordHash;");
            sb.AppendLine(@"            byte[] PasswordSalt;");
            sb.AppendLine(@"            string RandomToken = """";");
            sb.AppendLine(@"");
            sb.AppendLine(@"            contactService.CreatePasswordHash_Salt_RandomToken(contact, out PasswordHash, out PasswordSalt, out RandomToken);");
            sb.AppendLine(@"            contact.PasswordHash = PasswordHash;");
            sb.AppendLine(@"            contact.PasswordSalt = PasswordSalt;");
            sb.AppendLine(@"            contact.RandomToken = RandomToken;");
            sb.AppendLine(@"");
