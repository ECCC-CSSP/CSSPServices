...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillInfrastructure_B
        private IQueryable<Infrastructure_B> FillInfrastructure_B()
        {
            ...
            List<EnumIDAndText> AlarmSystemTypeEnumList = enums.GetEnumTextOrderedList(typeof(AlarmSystemTypeEnum));
             ...
             IQueryable<Infrastructure_B> Infrastructure_BQuery = (from c in db.Infrastructures
        ...
        #endregion Functions private Generated FillInfrastructure_B
