...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillVPScenario_A
        private IQueryable<VPScenario_A> FillVPScenario_A()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> ScenarioStatusEnumList = enums.GetEnumTextOrderedList(typeof(ScenarioStatusEnum));

             IQueryable<VPScenario_A> VPScenario_AQuery = (from c in db.VPScenarios
        ...
        #endregion Functions private Generated FillVPScenario_A
