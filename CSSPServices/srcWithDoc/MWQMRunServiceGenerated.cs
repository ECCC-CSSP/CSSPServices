...
namespace CSSPServices
{
    ...
    public partial class MWQMRunService : BaseService
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (mwqmRun.DischargeDay0_m3_s != null)
            {
                if (mwqmRun.DischargeDay0_m3_s < 0 || mwqmRun.DischargeDay0_m3_s > 300)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay0_m3_s", "0", "300"), new[] { "DischargeDay0_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay1_m3_s != null)
            {
                if (mwqmRun.DischargeDay1_m3_s < 0 || mwqmRun.DischargeDay1_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay1_m3_s", "0", "100000"), new[] { "DischargeDay1_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay2_m3_s != null)
            {
                if (mwqmRun.DischargeDay2_m3_s < 0 || mwqmRun.DischargeDay2_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay2_m3_s", "0", "100000"), new[] { "DischargeDay2_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay3_m3_s != null)
            {
                if (mwqmRun.DischargeDay3_m3_s < 0 || mwqmRun.DischargeDay3_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay3_m3_s", "0", "100000"), new[] { "DischargeDay3_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay4_m3_s != null)
            {
                if (mwqmRun.DischargeDay4_m3_s < 0 || mwqmRun.DischargeDay4_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay4_m3_s", "0", "100000"), new[] { "DischargeDay4_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay5_m3_s != null)
            {
                if (mwqmRun.DischargeDay5_m3_s < 0 || mwqmRun.DischargeDay5_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay5_m3_s", "0", "100000"), new[] { "DischargeDay5_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay6_m3_s != null)
            {
                if (mwqmRun.DischargeDay6_m3_s < 0 || mwqmRun.DischargeDay6_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay6_m3_s", "0", "100000"), new[] { "DischargeDay6_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay7_m3_s != null)
            {
                if (mwqmRun.DischargeDay7_m3_s < 0 || mwqmRun.DischargeDay7_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay7_m3_s", "0", "100000"), new[] { "DischargeDay7_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay8_m3_s != null)
            {
                if (mwqmRun.DischargeDay8_m3_s < 0 || mwqmRun.DischargeDay8_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay8_m3_s", "0", "100000"), new[] { "DischargeDay8_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay9_m3_s != null)
            {
                if (mwqmRun.DischargeDay9_m3_s < 0 || mwqmRun.DischargeDay9_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay9_m3_s", "0", "100000"), new[] { "DischargeDay9_m3_s" });
                }
            }

            if (mwqmRun.DischargeDay10_m3_s != null)
            {
                if (mwqmRun.DischargeDay10_m3_s < 0 || mwqmRun.DischargeDay10_m3_s > 100000)
                {
                    mwqmRun.HasErrors = true;
                    yield return new ValidationResult(string.Format(CSSPServicesRes._ValueShouldBeBetween_And_, "MWQMRunDischargeDay10_m3_s", "0", "100000"), new[] { "DischargeDay10_m3_s" });
                }
            }
