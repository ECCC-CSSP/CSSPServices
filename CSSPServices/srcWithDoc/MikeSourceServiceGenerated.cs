...
namespace CSSPServices
{
    ...
    public partial class MikeSourceService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MikeSourceExtraA model with the MikeSourceID identifier
        /// </summary>
        /// <param name="MikeSourceID">Is the identifier of [MikeSources](CSSPModels.MikeSource.html) table of CSSPDB</param>
        /// <returns>[MikeSourceExtraA](CSSPModels.MikeSourceExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeSourceExtraA](CSSPModels.MikeSourceExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeSourceExtraA](CSSPModels.MikeSourceExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MikeSourceExtraB model with the MikeSourceID identifier
        /// </summary>
        /// <param name="MikeSourceID">Is the identifier of [MikeSources](CSSPModels.MikeSource.html) table of CSSPDB</param>
        /// <returns>[MikeSourceExtraB](CSSPModels.MikeSourceExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MikeSourceExtraB](CSSPModels.MikeSourceExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MikeSourceExtraB](CSSPModels.MikeSourceExtraB.html)</returns>
