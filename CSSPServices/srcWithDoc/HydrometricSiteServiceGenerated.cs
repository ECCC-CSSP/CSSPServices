...
namespace CSSPServices
{
    ...
    public partial class HydrometricSiteService : BaseService
    {
        ...
        /// <summary>
        /// Gets the HydrometricSiteExtraA model with the HydrometricSiteID identifier
        /// </summary>
        /// <param name="HydrometricSiteID">Is the identifier of [HydrometricSites](CSSPModels.HydrometricSite.html) table of CSSPDB</param>
        /// <returns>[HydrometricSiteExtraA](CSSPModels.HydrometricSiteExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [HydrometricSiteExtraA](CSSPModels.HydrometricSiteExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [HydrometricSiteExtraA](CSSPModels.HydrometricSiteExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the HydrometricSiteExtraB model with the HydrometricSiteID identifier
        /// </summary>
        /// <param name="HydrometricSiteID">Is the identifier of [HydrometricSites](CSSPModels.HydrometricSite.html) table of CSSPDB</param>
        /// <returns>[HydrometricSiteExtraB](CSSPModels.HydrometricSiteExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [HydrometricSiteExtraB](CSSPModels.HydrometricSiteExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [HydrometricSiteExtraB](CSSPModels.HydrometricSiteExtraB.html)</returns>
