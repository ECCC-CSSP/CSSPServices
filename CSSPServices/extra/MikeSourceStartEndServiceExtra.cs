...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated MikeSourceStartEndFillReport
        private IQueryable<MikeSourceStartEndReport> FillMikeSourceStartEndReport()
        {
             IQueryable<MikeSourceStartEndReport>  MikeSourceStartEndReportQuery = (from c in db.MikeSourceStartEnds
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    where cl.TVItemID == c.LastUpdateContactTVItemID
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MikeSourceStartEndReport
                    {
                        MikeSourceStartEndReportTest = "Testing Report",
        ...
        #endregion Functions private Generated MikeSourceStartEndFillReport
