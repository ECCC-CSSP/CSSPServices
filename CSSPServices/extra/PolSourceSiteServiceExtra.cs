...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated PolSourceSiteFillReport
        private IQueryable<PolSourceSiteReport> FillPolSourceSiteReport()
        {
            ...
            List<EnumIDAndText> PolSourceInactiveReasonEnumList = enums.GetEnumTextOrderedList(typeof(PolSourceInactiveReasonEnum));
             ...
             IQueryable<PolSourceSiteReport>  PolSourceSiteReportQuery = (from c in db.PolSourceSites
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new PolSourceSiteReport
                    {
                        PolSourceSiteReportTest = "Testing Report",
        ...
        #endregion Functions private Generated PolSourceSiteFillReport
