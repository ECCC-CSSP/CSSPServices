...
namespace CSSPServices
{
    ...
    public partial class MWQMAnalysisReportParameterService : BaseService
    {
        ...
        /// <summary>
        /// Gets the MWQMAnalysisReportParameterExtraA model with the MWQMAnalysisReportParameterID identifier
        /// </summary>
        /// <param name="MWQMAnalysisReportParameterID">Is the identifier of [MWQMAnalysisReportParameters](CSSPModels.MWQMAnalysisReportParameter.html) table of CSSPDB</param>
        /// <returns>[MWQMAnalysisReportParameterExtraA](CSSPModels.MWQMAnalysisReportParameterExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMAnalysisReportParameterExtraA](CSSPModels.MWQMAnalysisReportParameterExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMAnalysisReportParameterExtraA](CSSPModels.MWQMAnalysisReportParameterExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the MWQMAnalysisReportParameterExtraB model with the MWQMAnalysisReportParameterID identifier
        /// </summary>
        /// <param name="MWQMAnalysisReportParameterID">Is the identifier of [MWQMAnalysisReportParameters](CSSPModels.MWQMAnalysisReportParameter.html) table of CSSPDB</param>
        /// <returns>[MWQMAnalysisReportParameterExtraB](CSSPModels.MWQMAnalysisReportParameterExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMAnalysisReportParameterExtraB](CSSPModels.MWQMAnalysisReportParameterExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMAnalysisReportParameterExtraB](CSSPModels.MWQMAnalysisReportParameterExtraB.html)</returns>
