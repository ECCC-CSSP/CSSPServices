...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated MWQMSampleFillReport
        private IQueryable<MWQMSampleReport> FillMWQMSampleReport()
        {
            Enums enums = new Enums(LanguageRequest);

            List<EnumIDAndText> SampleTypeEnumList = enums.GetEnumTextOrderedList(typeof(SampleTypeEnum));

             IQueryable<MWQMSampleReport>  MWQMSampleReportQuery = (from c in db.MWQMSamples
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MWQMSampleReport
                    {
                        MWQMSampleReportTest = "Testing Report",
        ...
        #endregion Functions private Generated MWQMSampleFillReport
