...
namespace CSSPServices
{
    ...
    {
        #region Functions private Generated FillMikeBoundaryCondition_B
        private IQueryable<MikeBoundaryCondition_B> FillMikeBoundaryCondition_B()
        {
            ...
            List<EnumIDAndText> TVTypeEnumList = enums.GetEnumTextOrderedList(typeof(TVTypeEnum));
             ...
             IQueryable<MikeBoundaryCondition_B> MikeBoundaryCondition_BQuery = (from c in db.MikeBoundaryConditions
                ...
                let LastUpdateContactTVItemLanguage = (from cl in db.TVItemLanguages
                    ...
                    && cl.Language == LanguageRequest
                    select cl).FirstOrDefault()
                    select new MikeBoundaryCondition_B
                    {
        ...
        #endregion Functions private Generated FillMikeBoundaryCondition_B
