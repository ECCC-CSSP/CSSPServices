...
namespace CSSPServices
{
    ...
    public partial class EmailDistributionListService : BaseService
    {
        ...
        /// <summary>
        /// Gets the EmailDistributionListExtraA model with the EmailDistributionListID identifier
        /// </summary>
        /// <param name="EmailDistributionListID">Is the identifier of [EmailDistributionLists](CSSPModels.EmailDistributionList.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListExtraA](CSSPModels.EmailDistributionListExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListExtraA](CSSPModels.EmailDistributionListExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListExtraA](CSSPModels.EmailDistributionListExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the EmailDistributionListExtraB model with the EmailDistributionListID identifier
        /// </summary>
        /// <param name="EmailDistributionListID">Is the identifier of [EmailDistributionLists](CSSPModels.EmailDistributionList.html) table of CSSPDB</param>
        /// <returns>[EmailDistributionListExtraB](CSSPModels.EmailDistributionListExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [EmailDistributionListExtraB](CSSPModels.EmailDistributionListExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [EmailDistributionListExtraB](CSSPModels.EmailDistributionListExtraB.html)</returns>
