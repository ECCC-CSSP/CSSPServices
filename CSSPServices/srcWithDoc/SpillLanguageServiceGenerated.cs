...
namespace CSSPServices
{
    ...
    public partial class SpillLanguageService : BaseService
    {
        ...
        /// <summary>
        /// Gets the SpillLanguageExtraA model with the SpillLanguageID identifier
        /// </summary>
        /// <param name="SpillLanguageID">Is the identifier of [SpillLanguages](CSSPModels.SpillLanguage.html) table of CSSPDB</param>
        /// <returns>[SpillLanguageExtraA](CSSPModels.SpillLanguageExtraA.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SpillLanguageExtraA](CSSPModels.SpillLanguageExtraA.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SpillLanguageExtraA](CSSPModels.SpillLanguageExtraA.html)</returns>
        ...
        /// <summary>
        /// Gets the SpillLanguageExtraB model with the SpillLanguageID identifier
        /// </summary>
        /// <param name="SpillLanguageID">Is the identifier of [SpillLanguages](CSSPModels.SpillLanguage.html) table of CSSPDB</param>
        /// <returns>[SpillLanguageExtraB](CSSPModels.SpillLanguageExtraB.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [SpillLanguageExtraB](CSSPModels.SpillLanguageExtraB.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [SpillLanguageExtraB](CSSPModels.SpillLanguageExtraB.html)</returns>
